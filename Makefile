.PHONY: help install dev test test-cov lint format clean docker-build docker-up docker-down migrate migrate-create deploy-dev deploy-staging deploy-prod
...
help:
	...
	@echo "  make lint          - Run linters (mypy)"
